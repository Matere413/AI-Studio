...
(Previously: planning received selected assets but did not require metadata-aware strict selected-asset reasoning.)
...
(Previously: clarification covered generic ambiguity but not selected-asset role ambiguity.)
...
(Previously: guidance covered missing roles but not uploading or failed selected assets.)
...
(Previously: Flux 2 editing/text generation were listed as approved typed flows.)
