...
- **Design System Reference**: ALL frontend views, components, and interactive elements MUST strictly follow the design system located at `./Design  reference/ai-studio-design-system/` as the single source of truth for design. Do not invent ad-hoc styles. 
- **Regla Estricta Front-end**: Siempre que se toque, modifique o cree código del frontend, es **obligatorio** leer y usar los archivos en `./Design  reference/ai-studio-design-system/` como referencia visual y estructural.
- Align visually and behaviorally with established primitives, typography scale, spacing, and border-radius.
